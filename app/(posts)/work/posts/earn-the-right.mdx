...
slug: earn-the-right
tags: ['iOS', 'apps', 'development']
summary: A companion app built to accompany the book (of the same title) written by Patrick Youngblood

media: 
    '/images/earnTheRightApp.png'

time:
  created: "2023-01-23T18:42:55-07:00"
  updated: "2023-01-23T18:42:55-07:00"

seo:
  title: "Earn the Right - iOS Development Journey"
  description: "A companion app built to accompany the book Earn the Right"
  keywords: ["iOS", "apps", "development", "journal", "companion app"]
---

<div className="-mx-2 flex flex-wrap overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-1/2 xl:px-2">
    <Image src="/images/earnTheRightApp.png" alt="Earn the Right App" width={500} height={500} />
  </div>
</div>
